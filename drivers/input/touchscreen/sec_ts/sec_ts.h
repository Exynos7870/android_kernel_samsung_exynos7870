...
#define SEC_TS_TOUCHKEY_EVENT		3
...
#define SEC_TS_DEBUG_PRINT_I2C_CMD	0x4
...
#define SEC_TS_TOUCHKEY_ACTION_NONE		0
#define SEC_TS_TOUCHKEY_ACTION_PRESS	1
#define SEC_TS_TOUCHKEY_ACTION_MOVE		2
#define SEC_TS_TOUCHKEY_ACTION_RELEASE	3

/* 8 byte */
struct sec_ts_event_touchkey {
	u8 eid:2;
	u8 kid:4;
	u8 tchsta:2;
	u8 key_data_1;
...
struct sec_ts_data {
	...
	int sec_ts_tsk[SUPPORT_TSK_NUM];
