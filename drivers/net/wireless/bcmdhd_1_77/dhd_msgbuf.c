 ...
 *
 * $Id: dhd_msgbuf.c 727729 2017-10-23 11:02:57Z $
 */
	...
	uint d11_lpbk, uint core_num)
{
	...
	dmap->flags = ((prot->dmaxfer.d11_lpbk & PCIE_DMA_XFER_FLG_D11_LPBK_MASK) |
		((core_num & PCIE_DMA_XFER_FLG_CORE_NUMBER_MASK)
