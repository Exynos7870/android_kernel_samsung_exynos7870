...
struct lcd_info {
	...
	union {
		u32 value;
		unsigned char id[S6D78A0_ID_LEN];
	} id_info;
...
static int s6d78a0_probe(struct dsim_device *dsim)
{
	int ret = 0;
